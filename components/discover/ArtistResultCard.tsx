...
export function ArtistResultCard({ artist: a, onPress }: { artist: ArtistResult; onPress: () => void }) {
  return (
    <TouchableOpacity style={pplStyles.artistCard} activeOpacity={0.88} onPress={onPress}>
      <View style={pplStyles.artistBanner}>
        ...
        <LinearGradient colors={["transparent", "rgba(22,22,24,0.6)"]} style={StyleSheet.absoluteFill} pointerEvents="none" />
      </View>
      ...
      <View style={pplStyles.artistInfo}>
        <View style={pplStyles.nameRow}>
          ...
          <View style={pplStyles.artistBadge}><Text style={pplStyles.artistBadgeText}>Artist</Text></View>
        </View>
