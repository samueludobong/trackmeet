...
export function ProfileOverlays({
  ...
  return (
    ...
    {/* Lazy-mount: EditProfileOverlay pulls in BannerColorOverlay,
        EditProfilePinnedSong, EditProfileSocialLinks etc. — eager-mounting
        all that on every Profile-tab visit was the main Feed→Profile delay. */}
    {editOpen && (
      <EditProfileOverlay
        visible={editOpen}
